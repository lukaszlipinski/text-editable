...
export function buildMenuItems(schema) {
    ...
    if (type = schema.marks.customStyles) {
        r.toggleCustomStyles = markItem(type, {title: "Toggle custom style", icon: icons.strong});
    }
    if (type = schema.marks.customStyles2) {
        r.toggleCustomStyles2 = markItem(type, {title: "Toggle custom2 style", icon: icons.strong});
    }
